...
def _report_markdown(
    ...
    lines = [
        ...
        _markdown_table(
            top_premiums,
            ["area", "h3_res10", "cell_count", "cell_median_ppsqm", "area_median_ppsqm", "premium_vs_area_pct"],
        ),
        "",
        "## Top Discount Cells",
        "",
        ...
        _markdown_table(
            area_spread.head(50),
            ["area", "cells", "listings", "p10_premium_pct", "p90_premium_pct", "spread_p90_p10_pct"],
        ),
        "",
    ]
    return "\n".join(lines)
