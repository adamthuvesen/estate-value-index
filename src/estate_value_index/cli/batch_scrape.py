...
Usage:
    python -m estate_value_index.cli batch --batches 10 --max-pages 5 --start-page-min 1 --start-page-max 200
    python -m estate_value_index.cli batch --batches 8 --max-pages 10 --promote --upload-bq
"""
