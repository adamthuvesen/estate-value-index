...
Usage:
    python -m estate_value_index.cli value-analysis
    python -m estate_value_index.cli value-analysis --data-file data/raw/booli/custom.json
    python -m estate_value_index.cli value-analysis --model-type lgbm
    python -m estate_value_index.cli value-analysis --output data/custom_analysis.json
"""
