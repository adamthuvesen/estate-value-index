...
Usage:
    python -m estate_value_index.cli process --input data/raw/booli/booli_listings_*.json
"""
...
Examples:
  ...
  python -m estate_value_index.cli process --input data/raw/booli/booli_listings_20251002.json

  # Dry run to preview changes
  python -m estate_value_index.cli process --input new_scrape.json --dry-run

  # Custom parameters
  python -m estate_value_index.cli process --input new_scrape.json --min-area-count 3 --days-threshold 500
            """,
        )
